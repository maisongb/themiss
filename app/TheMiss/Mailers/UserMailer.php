...
class UserMailer extends Mailer
{
    ...
    {
        $events->listen('user.signup', 'TheMiss\Mailers\UserMailer@welcome');
        $events->listen('user.resend', 'TheMiss\Mailers\UserMailer@welcome');
        $events->listen('user.forgot', 'TheMiss\Mailers\UserMailer@forgotPassword');
        $events->listen('user.newpassword', 'TheMiss\Mailers\UserMailer@newPassword');
    }
